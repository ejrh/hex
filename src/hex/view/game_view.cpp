...
GameView::GameView(Game *game, Resources *resources, MessageReceiver *dispatcher):
        game(game), level_view(&game->level), resources(resources), dispatcher(dispatcher),
